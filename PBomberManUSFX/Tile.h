...
class BomberRobot;             // Incluir BomberRobot      ejercicio Examen 9
class Bomberman;
class MuroCeramica;
class MuroMetal;
class SueloCesped;
...
{
private:
	BomberRobot* bomberRobot;       //crear puntero de tipo BomberRobot
	Bomberman* bomberman;
...
public:
	...
	// Metodos accesores
	BomberRobot* getBomberRobot() { return bomberRobot; }       //Crear get de BomberRobot
	...
	void setBomberRobot(BomberRobot* _bomberRobot) { bomberRobot = _bomberRobot; }    //Crear set de BomberRobot
